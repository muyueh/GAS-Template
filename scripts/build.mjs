...
const entrypointWrappers = [
  ...
  '}',
  'function createSheetsComponentShowcase(title) {',
  '  return globalThis.__GAS_TEMPLATE__.createSheetsComponentShowcase(title);',
  '}',
  'function createSlidesFeatureShowcase(title) {',
  '  return globalThis.__GAS_TEMPLATE__.createSlidesFeatureShowcase(title);',
  '}',
  'function createDocsComponentShowcase(title) {',
  '  return globalThis.__GAS_TEMPLATE__.createDocsComponentShowcase(title);',
  '}',
